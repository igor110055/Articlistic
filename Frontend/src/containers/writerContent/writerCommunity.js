    ...
    <>
      <div className={classes.communityLine}>
        <p style={{ alignSelf: "center", width: "50%" }}>
          ...
          stories. Have 1:1 chat 💬 with them privately 🔒 or make it public
          below your story 🎙️. Designed to cultivate intimate relationship and
          convert your Casual Fans 👻 into Super Fans 🦸‍♂️ overtime.
        </p>
      </div>
