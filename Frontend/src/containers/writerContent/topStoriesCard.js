      ...
      >
        <div>
          <div className={classes.articleCardImageContainer}>
            <img src={articlePic} className={classes.articleCardImage} />
          </div>
        ...
        <div>
          <div className={classes.articleDescriptionContaner}>
            <div className={classes.articleCardDescription}>
              ...
              &nbsp;{parseInt(readingTime) === 1 || parseInt(readingTime) === 0 ? `${parseInt(readingTime)} min Read`: `${parseInt(readingTime)} mins Read`} 
            </div>
