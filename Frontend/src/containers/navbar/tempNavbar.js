        ...
        <div className="topnav" id="myTopnav">
            <a>
                <div className="nav-left">
                    <div className="nav-logo" style={{ cursor: 'pointer'}} onClick={refreshPage}>
            ...
            <div className="nav-right">
                ...
                <a id="login" className="right-content dropdown" onClick={() => openSignup ? setOpenSignup(false) : setOpenSignup(true)}>
                    <img src={userImage} className="nav-logged-in dropbtn" />
                    {!isLoggingOut && <div className="dropdown-content">
