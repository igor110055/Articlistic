        ...
        <div className="nav-bookmark">
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M25 29L19.1765 25.069L14 29V10H25V29Z"
              stroke="#2B406E"
              strokeWidth="2"
              strokeLinecap="round"
        ...
        <div className="nav-notification">
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M26 25H13L15.1014 15.9489C15.4983 14.2387 17.3466 13 19.5 13C21.6534 13 23.5017 14.2387 23.8986 15.9489L26 25Z"
              stroke="#2B406E"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            <g mask="url(#mask0_360_4757)">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M21.6685 26.7227C21.6685 27.9804 20.6977 28.9997 19.4999 28.9997C18.3027 28.9997 17.332 27.9804 17.332 26.7227H21.6685Z"
                fill="#3295FF"
              />
            </g>
            <path
