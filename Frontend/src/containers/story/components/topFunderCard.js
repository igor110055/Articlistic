...
function TopFunderCard({ firstFunder }) {
  return (
    <div className={`topfunder-container ${firstFunder ? "firstfunder-container": ''}`} >
      ...
      <div className={`top-funder-amount-div  ${firstFunder ? "first-funder-amount-div": ''}`}>
