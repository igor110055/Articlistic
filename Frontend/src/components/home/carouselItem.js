    ...
    <div className={classes.carouselItem}>
      <div className={classes.carouselItemsLeft}>
        <div className={classes.carouselImageLeftContainer}>
          <img
            className={classes.carouselImageLeft}
            src={dummyImage}
            alt="carousel"
          />
        </div>
        <div className={classes.carouselLeftContentContainer}>
          <div className={classes.carouselLeftContent}>
            <div className={classes.carouselImageLeftTitle}>
              Watch Apple's WWDC keynote live right here a sjfha sjfg jasg sja
              gsjasga jhgf jasgf
            </div>
            <div className={classes.carouselImageLeftSubtitle}>
              It appears the feature will work on Chromebooks and PCs running
              Chrome as…
            </div>
      ...
      <div className={classes.carouselItemsRight}>
        <img className={classes.carouselImageRight} src={dummyImage} alt="dummy"/>
      </div>
    </div>
  );
};
