          ...
          {[
            ...
            <ListItem button key={text}>
              <div className={classes.writersWithCardsProfile}>
                <div>
                  <div
                    className={classes.writersWithCardsProfileImageContainer}
                  >
                    {index % 2 === 0 ? (
                      <img
                        src={userPhoto}
                        className={classes.writersWithCardsProfileImage}
                        alt="profile"
                      />
                    ) : (
                      <img
                ...
                {open && (
                  <div className={classes.writersWithCardsProfileName}>
                    {text}
                  </div>
                )}
              </div>
