            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
                <div>
                    <div className={classes.articleCardImageContainer}>
                        <img src={dummyImage} className={classes.articleCardImage} />
                    </div>
                    <div className={classes.articleCardTitle}>
                        Android’s AirDrop-style file sharing feature may be Android’s AirDrop-style file sharing feature may be
                    </div>
                    <div className={classes.articleCardSubtitle}>
                        It appears the feature will work on the Chromebooks and PCs running  as…
                    </div>
                </div>
                <div>
                    <div className={classes.articleDescriptionContaner}>
                        <div className={classes.articleCardDescription}>
                            By &nbsp;<div className={classes.articleCardAuthor}>Kim Lyons &nbsp;</div> | June 21
                            &nbsp;&nbsp;
                            <div className={classes.svgIcons}>
                                <svg width="19" height="12" viewBox="0 0 19 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 5.26074H6.89" stroke="#2B406E" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1 11.2607H11.043" stroke="#2B406E" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1 8.26074H7.902" stroke="#2B406E" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1 2.26074H6.059" stroke="#3095FF" stroke-linecap="round" stroke-linejoin="round" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M18.3566 5.50298C18.3566 7.98898 16.3406 10.005 13.8546 10.005C11.3676 10.005 9.35156 7.98898 9.35156 5.50298C9.35156 3.01598 11.3676 1.00098 13.8546 1.00098C16.3406 1.00098 18.3566 3.01598 18.3566 5.50298Z" stroke="#3095FF" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M13.7656 3.14551V5.50351L15.0166 6.91451" stroke="#2B406E" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            &nbsp;6 min Read
                        </div>
                        {dummyImage === '/static/media/image (3).2902fcf1.png' && <Dialog open={openBookmarkDialog} onClose={() => setOpenBookmarkDialog(false)}>
                            <DialogTitle>Do you really want to unbookmark  this story?</DialogTitle>
                        ...
                        <div className={classes.svgIcons} style={{ cursor: 'pointer' }} onClick={() => setOpenBookmarkDialog(true)}>
                            <svg width="12" height="17" viewBox="0 0 12 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 3H11" stroke="#3095FF" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11 16.5L5.70588 13.1897L1 16.5V0.5H11V16.5Z" stroke="#2B406E" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    </div>
                </div>
