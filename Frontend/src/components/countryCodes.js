const CountryCodes = ({
    ...
    return (
        <div>
            <select id="scripts" style={{ outline: 'none', borderRadius: '5px', border: 'none', cursor: 'pointer', fontFamily: 'Poppins', boxShadow: 'none' }} onChange={(e) => setCountry(e.target.value)}>
