...
import { ErrorMessage } from "../containers/authentication/components/errorMessageFunction/errorMessageFunction";
...
export const authDeleteRequest = async (url, headers) => {
  try {
    const data = await axios
