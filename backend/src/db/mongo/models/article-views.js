...
const collection = MDB_COLLECTION_ARTICLE_VIEWS;
...
async function incrementRead(articleId) {
    ...
    try {
        ...
        logger.info("increment view mongo response time: " + timeTaken.toString());
...
async function getViewsForSpecificArticle(articleId) {
    ...
    try {
        ...
        logger.info("getViewsForSpecificArticle mongo response time: " + timeTaken.toString());
